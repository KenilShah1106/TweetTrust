...
@section('hero-header-left')
    <h2 class="hero-title m-0">Edit a Tweet</h2>
@endsection

@section('hero-body')
    <div class="bg-white p16 br-10">
        <form action="{{route('tweets.update',$tweet->id)}}" class="m-0" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input id="body" type="hidden" name="body" value="{{ old('body', $tweet->body)}}">
            ...
            <div class="form-group">
                ...
                <select name="tags[]" id="tags" class="form-control select2" multiple>
                    ...
                    @foreach ($tags as $tag)
                        @if((old('tags') && (in_array($tag->id, old('tags')))) || $tweet->hasTag($tag->id) )
